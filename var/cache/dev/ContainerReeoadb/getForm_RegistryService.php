...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AdamQuaile\\Bundle\\FieldsetBundle\\Form\\FieldsetType' => function () {
    return ${($_ = isset($this->services['adamquaile.fieldset.type']) ? $this->services['adamquaile.fieldset.type'] : ($this->services['adamquaile.fieldset.type'] = new \AdamQuaile\Bundle\FieldsetBundle\Form\FieldsetType())) && false ?: '_'};
}, 'FOS\\UserBundle\\Form\\Type\\ChangePasswordFormType' => function () {
    return ${($_ = isset($this->services['fos_user.change_password.form.type']) ? $this->services['fos_user.change_password.form.type'] : ($this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('DirectoryPlatform\\AppBundle\\Entity\\User'))) && false ?: '_'};
}, 'FOS\\UserBundle\\Form\\Type\\ProfileFormType' => function () {
    return ${($_ = isset($this->services['fos_user.profile.form.type']) ? $this->services['fos_user.profile.form.type'] : ($this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('DirectoryPlatform\\AppBundle\\Entity\\User'))) && false ?: '_'};
}, 'FOS\\UserBundle\\Form\\Type\\RegistrationFormType' => function () {
    return ${($_ = isset($this->services['fos_user.registration.form.type']) ? $this->services['fos_user.registration.form.type'] : ($this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('DirectoryPlatform\\AppBundle\\Entity\\User'))) && false ?: '_'};
}, 'FOS\\UserBundle\\Form\\Type\\ResettingFormType' => function () {
    return ${($_ = isset($this->services['fos_user.resetting.form.type']) ? $this->services['fos_user.resetting.form.type'] : ($this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('DirectoryPlatform\\AppBundle\\Entity\\User'))) && false ?: '_'};
    ...
    return ${($_ = isset($this->services['payum.form.type.credit_card_expiration_date']) ? $this->services['payum.form.type.credit_card_expiration_date'] : ($this->services['payum.form.type.credit_card_expiration_date'] = new \Payum\Core\Bridge\Symfony\Form\Type\CreditCardExpirationDateType())) && false ?: '_'};
}, 'Payum\\Core\\Bridge\\Symfony\\Form\\Type\\CreditCardType' => function () {
    return ${($_ = isset($this->services['payum.form.type.credit_card']) ? $this->services['payum.form.type.credit_card'] : ($this->services['payum.form.type.credit_card'] = new \Payum\Core\Bridge\Symfony\Form\Type\CreditCardType())) && false ?: '_'};
}, 'Payum\\Core\\Bridge\\Symfony\\Form\\Type\\GatewayConfigType' => function () {
    return ${($_ = isset($this->services['payum.form.type.gateway_config']) ? $this->services['payum.form.type.gateway_config'] : $this->load('getPayum_Form_Type_GatewayConfigService.php')) && false ?: '_'};
}, 'Payum\\Core\\Bridge\\Symfony\\Form\\Type\\GatewayFactoriesChoiceType' => function () {
    return ${($_ = isset($this->services['payum.form.type.gateway_factories_choice']) ? $this->services['payum.form.type.gateway_factories_choice'] : ($this->services['payum.form.type.gateway_factories_choice'] = new \Payum\Core\Bridge\Symfony\Form\Type\GatewayFactoriesChoiceType([]))) && false ?: '_'};
    ...
    yield 0 => ${($_ = isset($this->services['payum.form.extension.gateway_factories_choice']) ? $this->services['payum.form.extension.gateway_factories_choice'] : $this->load('getPayum_Form_Extension_GatewayFactoriesChoiceService.php')) && false ?: '_'};
